...
*/
    (function() {
            ...
            for (B = H.length; l < B; ++l)(function() {
                ...
                g.src = "https://cdn.jsdelivr.net/gh/jABER-IT/BlogSite-All-Host-File/code-prettify/loader/lang-" + encodeURIComponent(H[l]) + ".js";
                N.insertBefore(g, N.firstChild)
														
            })(H[l]);
            for (var S = H.length, F = [], l = 0, B = P.length; l < B; ++l) F.push("https://cdn.jsdelivr.net/gh/jABER-IT/BlogSite-All-Host-File/code-prettify/loader/skins/" + encodeURIComponent(P[l]) + ".css");
            F.push("https://cdn.jsdelivr.net/gh/jABER-IT/BlogSite-All-Host-File/code-prettify/loader/prettify.js");
            (function(g) {
                function r(l) {
                    if (l !== x) {
